// ============================================================
// FILE: src/facade/RestaurantFacade.java
// ============================================================
package facade;
...
/**
 * RestaurantFacade - Facade Pattern implementation
 * Provides simplified interface to complex subsystem of design patterns
 * Coordinates Factory, Builder, Decorator, Strategy, and Observer patterns
 */
public class RestaurantFacade {
    
    /**
     * Constructor - initializes facade
     */
    public RestaurantFacade() {
        System.out.println("Restaurant Facade initialized");
        System.out.println("All subsystems ready (Factory, Builder, Decorator, Strategy, Observer)");
    }
    
    /**
     * Place a complete order using all design patterns
     * This ONE method coordinates 6 different design patterns!
     * 
     * @param customerName Customer name
     * @param mealType Type of meal (Factory)
     * @param addExtras Whether to add decorators
     * @param dough Pizza dough type (Builder)
     * @param topping Pizza topping (Builder)
     * @param paymentMethod Payment method (Strategy)
     */
    public void placeCompleteOrder(String customerName, String mealType, 
        ...
        try {
            // Step 1: Use FACTORY PATTERN to create base meal
            ...
            // Step 2: Use DECORATOR PATTERN if extras requested
            if (addExtras) {
            ...
            // Step 3: Use BUILDER PATTERN for custom pizza
            ...
            // Step 4: Use OBSERVER PATTERN for notifications
            ...
            // Step 5: Use STRATEGY PATTERN for payment
            ...
            if (paymentMethod.equalsIgnoreCase("PayPal")) {
                ...
                strategy = new CashPayment(100.00);
            } else {
                strategy = new CreditCardPayment("4111111111111111", 
                                                customerName, "123", "12/26");
            }
...
/**
 * Main class - Entry point for Restaurant Ordering System
 * Demonstrates integration of all 6 design patterns
 * 
